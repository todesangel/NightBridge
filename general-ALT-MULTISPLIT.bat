...
rem ================================================================
rem Профиль: general-ALT-MULTISPLIT.bat
rem Для каких блокировок: более строгие DPI, где обычный split недостаточен.
rem Побочные эффекты: может повышать latency и нагрузку, возможны редкие отказы соединений.
rem Когда использовать: если baseline не помогает и нужна более агрессивная десинхронизация.
rem ================================================================
...
set "DESYNC_MODE=multisplit"
set "DESYNC_FLAGS=--dpi-desync-any-protocol --dpi-desync-cutoff n2"
